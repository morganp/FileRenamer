...
//
/*
 * FileExplorer, Java based file renamer.
...
public class AboutBox extends JFrame implements ActionListener {
    ...
    public AboutBox() {
        ...
        aboutLabel[1] = new JLabel("File Renamer");
        aboutLabel[1].setFont(titleFont);
        aboutLabel[2] = new JLabel("Version 0.1.0");
        ...
        aboutLabel[6] = new JLabel("Copyright (c) 2010 Morgan Prior. \n" 
